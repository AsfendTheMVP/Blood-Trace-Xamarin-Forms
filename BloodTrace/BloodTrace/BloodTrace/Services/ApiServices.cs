...
namespace BloodTrace.Services
{
    public class ApiServices
    {
        public async Task<bool> RegisterUser(string email, string password, string confirmPassword)
        {
            ...
            var response = await httpClient.PostAsync("https://PutYoutWebAppNameHere.azurewebsites.net/api/Account/Register", content);
        ...
        public async Task<bool> LoginUser(string email, string password)
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://PutYoutWebAppNameHere.azurewebsites.net/Token");
        ...
        public async Task<List<BloodUser>> FindBlood(string country, string bloodType)
        {
            ...
            var bloodApiUrl = "https://PutYoutWebAppNameHere.azurewebsites.net/api/BloodUsers";
